...
ffa089c0:	00 e1 31 40 	R0.L = 0x4031;		/* (16433)	R0=0xff804031(-8372175) */
ffa089c4:	40 e1 80 ff 	R0.H = 0xff80;		/* (-128)	R0=0xff804031(-8372175) */
ffa089c8:	70 bb       	[FP -0x24] = R0;
ffa089ca:	00 e1 33 40 	R0.L = 0x4033;		/* (16435)	R0=0xff804033(-8372173) */
ffa089ce:	40 e1 80 ff 	R0.H = 0xff80;		/* (-128)	R0=0xff804033(-8372173) */
ffa089d2:	80 bb       	[FP -0x20] = R0;
ffa089d4:	00 e1 69 40 	R0.L = 0x4069;		/* (16489)	R0=0xff804069(-8372119) */
ffa089d8:	40 e1 80 ff 	R0.H = 0xff80;		/* (-128)	R0=0xff804069(-8372119) */
ffa089dc:	90 bb       	[FP -0x1c] = R0;
ffa089de:	00 e1 6b 40 	R0.L = 0x406b;		/* (16491)	R0=0xff80406b(-8372117) */
ffa089e2:	40 e1 80 ff 	R0.H = 0xff80;		/* (-128)	R0=0xff80406b(-8372117) */
...
ffa09d8e:	20 e1 54 00 	R0 = 0x54 (X);		/*		R0=0x54( 84) */
