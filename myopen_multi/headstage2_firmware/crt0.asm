...
setupPLL:
	...
	/* now, set clock dividers, Core and system clock dividers.
       Manual page 339:
       
       VCO = MSEL*CLKIN = 25*16MHz=400MHz
       CCLK = VCO/1 = 400MHz, since CSEL=00
       SCLK = VCO/5 = 80MHz, since SSEL=0101=5
    */
...
// install default interrupt handlers
	...
	p0.l = LO(SIC_IMASK); 
	p0.h = HI(SIC_IMASK); 
	r0.l = 0x3e00; //SPI, SPORT1 Tx & Rx, SPORT0 Tx & Rx
	r0.h = 0x0000; 
	[p0] = r0; 
	...
	p0.l = LO(SIC_IAR1); 
	p0.h = HI(SIC_IAR1);
	r0.l = 0x343f; //sport0/1 rx -> IVG10 & sport0/1 tx -> IVG11 
	r0.h = 0xffff; 
	[p0] = r0;
