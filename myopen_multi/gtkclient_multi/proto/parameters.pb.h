...
#ifndef PROTOBUF_proto_2fparameters_2eproto__INCLUDED
#define PROTOBUF_proto_2fparameters_2eproto__INCLUDED
...
class units : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_proto_2fparameters_2eproto();
  friend void protobuf_AssignDesc_proto_2fparameters_2eproto();
  friend void protobuf_ShutdownFile_proto_2fparameters_2eproto();
...
class state : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_default_configuration(::std::string* default_configuration);
...
inline void state::set_allocated_default_configuration(::std::string* default_configuration) {
  if (default_configuration_ != &::google::protobuf::internal::kEmptyString) {
...
#endif  // PROTOBUF_proto_2fparameters_2eproto__INCLUDED
