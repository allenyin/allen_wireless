...
#ifndef PROTOBUF_proto_2fspikes_2eproto__INCLUDED
#define PROTOBUF_proto_2fspikes_2eproto__INCLUDED
...
class Spike_msg : public ::google::protobuf::Message {
 public:
  ...
  inline void set_allocated_w(::std::string* w);
 ...
 private:
  ...
  friend void  protobuf_AddDesc_proto_2fspikes_2eproto();
  friend void protobuf_AssignDesc_proto_2fspikes_2eproto();
  friend void protobuf_ShutdownFile_proto_2fspikes_2eproto();
...
inline void Spike_msg::set_allocated_w(::std::string* w) {
  if (w_ != &::google::protobuf::internal::kEmptyString) {
    delete w_;
  }
  if (w) {
...
#endif  // PROTOBUF_proto_2fspikes_2eproto__INCLUDED
